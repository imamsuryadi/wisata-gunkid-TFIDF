...
<div class="container my-5 vh-100">
    ...
    @if ($wisataFavorites->isEmpty())
        <div class="text-center">
            <img src="https://img.freepik.com/premium-vector/flat-no-data-concept-outline-design-style-minimal-vector-illustration-landing-page-web-banner-infographics-hero-images_269730-1906.jpg" alt="No Favorites" class="img-fluid mb-4" style="max-width: 300px;">
                    ...
                    <div class="swiper-slide swiper-card card-hover">
                        <div class="position-relative">
                            @if ($item->gambar)
                                ...
                                @endphp
                                @if ($gambarPertama)
                                    <img src="{{ $gambarPertama }}" alt="Gambar" width="100" class="me-2 rounded-3" style="height: 230px">
                                @endif
                            @endif
                            <button 
                                type="button"
